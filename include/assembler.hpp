...
class Assembler {
  public:
     ...
     */
    static std::shared_ptr<AST::BaseNode> evaluate(std::shared_ptr<AST::BaseNode>);
     ...
     * @throws AssemblerException if any child is invalid.
     */
    static std::shared_ptr<AST::BaseInstruction> evaluateInstruction(std::shared_ptr<AST::BaseInstruction> node);
     ...
     * @throws AssemblerException if any child is invalid.
     */
    static std::shared_ptr<AST::BaseNode> evaluateBinaryOp(std::shared_ptr<AST::BaseBinaryOp> node);
     ...
     * @throws AssemblerException if any child is invalid.
     */
    static std::shared_ptr<AST::BaseNode> evaluateUnaryOp(std::shared_ptr<AST::BaseUnaryOp> node);
};
